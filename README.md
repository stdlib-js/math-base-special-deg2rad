...
```javascript
import deg2rad from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-deg2rad@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-deg2rad/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-base-special-deg2rad/actions/workflows/test.yml?query=branch:v0.2.2
